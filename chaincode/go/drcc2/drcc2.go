...
type PDCCContract interface {
	...
	UpdateData(shim.ChaincodeStubInterface, []string) peer.Response
}
...
func (cc *Chaincode) Invoke(APIstub shim.ChaincodeStubInterface) peer.Response {
	...
	if function == "AddData" {
		...
		return cc.UpdateData(APIstub, args)
	}
	return shim.Error("Invalid Smart Contract function name...")
}

func (cc *Chaincode) UpdateData(APIstub shim.ChaincodeStubInterface, args []string) peer.Response{
	if len(args) != 3 {
